...
function sendOrderConfirmationEmail_(body, orderNumber) {
  ...
  const htmlBody = [
    '<div style="margin:0;padding:24px;background:#f7f6f3;">',
    '<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #ece7dd;border-radius:16px;overflow:hidden;">',
    "<tr>",
    '<td style="padding:22px 24px;background:linear-gradient(135deg,#1c1c1a 0%,#2c2c2a 100%);">',
    '<img src="https://ideamos.ar/imprenta/wp-content/uploads/2026/03/logo-dark-29-bis.png" alt="29 BIS" style="height:34px;display:block;">',
    ...
    `<p style="margin:0 0 12px 0;color:#1c1c1a;font-family:Arial,sans-serif;font-size:18px;line-height:1.4;">Hola <strong>${escapeHtml_(customerName)}</strong>,</p>`,
    '<p style="margin:0;color:#3b3b38;font-family:Arial,sans-serif;font-size:15px;line-height:1.6;">Recibimos tu pedido correctamente. Ya está ingresado en nuestro flujo de producción.</p>',
    "</td>",
    "</tr>",
    "<tr>",
    '<td style="padding:0 24px 10px 24px;">',
    '<div style="border:1px solid #f1b8cf;background:#fff5f9;border-radius:12px;padding:14px 16px;">',
    ...
    `<p style="margin:0;color:#e84883;font-family:Arial,sans-serif;font-size:24px;font-weight:700;line-height:1.2;">${escapeHtml_(orderNumber)}</p>`,
    "</div>",
    "</td>",
    "</tr>",
    "<tr>",
    ...
    `<tr><td style="padding:8px 0;border-bottom:1px solid #f0ece5;color:#6a6966;font-family:Arial,sans-serif;font-size:14px;">Forma de pago</td><td align="right" style="padding:8px 0;border-bottom:1px solid #f0ece5;color:#1c1c1a;font-family:Arial,sans-serif;font-size:14px;font-weight:700;">${escapeHtml_(paymentLabel)}</td></tr>`,
    `<tr><td style="padding:8px 0;border-bottom:1px solid #f0ece5;color:#6a6966;font-family:Arial,sans-serif;font-size:14px;">Retiro</td><td align="right" style="padding:8px 0;border-bottom:1px solid #f0ece5;color:#1c1c1a;font-family:Arial,sans-serif;font-size:14px;font-weight:700;">${escapeHtml_(pickup)}</td></tr>`,
    `<tr><td style="padding:8px 0;color:#6a6966;font-family:Arial,sans-serif;font-size:14px;">Archivos</td><td align="right" style="padding:8px 0;color:#1c1c1a;font-family:Arial,sans-serif;font-size:14px;font-weight:700;">${escapeHtml_(filesText)}</td></tr>`,
    "</table>",
    "</td>",
    "</tr>",
    "<tr>",
    '<td style="padding:12px 24px 22px 24px;">',
    '<div style="border:1px solid #f5d38a;background:#fff8e9;border-radius:10px;padding:12px 14px;">',
    '<p style="margin:0;color:#6e4b0f;font-family:Arial,sans-serif;font-size:14px;line-height:1.6;">Si abonaste por transferencia, enviá el comprobante a <strong>pedidos@29bis.com.ar</strong> indicando tu número de pedido.</p>',
    "</div>",
    ...
    '<p style="margin:0;color:#6a6966;font-family:Arial,sans-serif;font-size:12px;line-height:1.5;">©2026 29 BIS · Creado con ❤️ por <a href="https://ideamos.com.ar" style="color:#e84883;text-decoration:none;font-weight:700;">Estudio Ideamos</a></p>',
    "</td>",
    "</tr>",
    "</table>",
    "</div>"
